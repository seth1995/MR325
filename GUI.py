...
class MainFrame(Tkinter.Frame):  
    ...
    def createFrame(self):  
        ...
        self.lfc_field_1_l = Tkinter.Button(lfc_field_1, text="打开文件：", width=10,command=self.openFile)  
        ...
        self.lfc_field_1_b = Tkinter.Button(lfc_field_1, text="运行：", width=10, height=1, command=self.var)  
        self.lfc_field_1_b.pack(fill="none", expand=0, side=Tkinter.RIGHT, anchor=Tkinter.SE)  
