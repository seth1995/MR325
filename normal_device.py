...
class Vsrc(Element):
    ...
    def SinStamp(self, var, t):
        ...
        sin_value = self.offset + self.amplitude * \
            math.sin(2 * math.pi * t * self.frequency + self.phase)  # sin
    ...
    def PulseStamp(self, var, t):
        ...
        pulse_value = 0  # pulse
        if (t <= self.pulse_td):
            pulse_value = t / self.pulse_td * \
                (self.pulse_v2 - self.pulse_v1) + self.pulse_v1
            ...
            pulse_value = self.pulse_v2 - \
                (t - self.pulse_td - self.pulse_pw) / self.pulse_tf * (self.pulse_v2 - self.pulse_v1)
        else:
